...
const extendedPagesEn: ExtendedPagesLocale = {
  ...
  changelogPage: {
    ...
    entryTitle: 'VFXRun Browser 1.3.3',
    ...
    item6: 'Added macOS Apple Silicon build.',
    item7: 'Hidden automatic update option until the update pipeline is ready.',
...
export const extendedPagesI18n: Record<Locale, ExtendedPagesLocale> = {
  ...
  'zh-CN': deepMergeMessages(extendedPagesEn, {
    ...
    changelogPage: {
      ...
      item6: '新增 macOS Apple Silicon 版本。',
      item7: '在更新通道就绪前隐藏自动更新选项。',
  ...
  ja: deepMergeMessages(extendedPagesEn, {
    ...
    changelogPage: {
      ...
      item6: 'macOS Apple Silicon 版を追加。',
      item7: '更新パイプラインの準備ができるまで自動更新オプションを非表示に。',
  ...
  ko: deepMergeMessages(extendedPagesEn, {
    ...
    changelogPage: {
      ...
      item6: 'macOS Apple Silicon 빌드를 추가했습니다.',
      item7: '업데이트 파이프라인이 준비될 때까지 자동 업데이트 옵션을 숨겼습니다.',
  ...
  es: deepMergeMessages(extendedPagesEn, {
    ...
    changelogPage: {
      ...
      item6: 'Añadida la compilación para macOS Apple Silicon.',
      item7: 'Ocultada la opción de actualización automática hasta que el canal de actualización esté listo.',
  ...
  fr: deepMergeMessages(extendedPagesEn, {
    ...
    changelogPage: {
      ...
      item6: 'Ajout de la build macOS Apple Silicon.',
      item7: 'Option de mise à jour automatique masquée jusqu’à ce que le canal de mise à jour soit prêt.',
